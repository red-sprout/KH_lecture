...
VALUES(201, 'USER01', 'PASS01', '홍길동', 'M', NULL, NULL, 'Y', '2000/01/01');

INSERT INTO TB_MEMBER 
VALUES(202, 'USER02', 'PASS02', '홍길순', 'F', '서울 강남구 압구정로', '010-2222-2222', DEFAULT, DEFAULT);

INSERT INTO TB_MEMBER 
VALUES(203, 'USER03', 'PASS03', '칸트', 'M', '독일 바이로이트', '333-3333-3333', DEFAULT, '2010/12/25');

INSERT INTO TB_MEMBER 
VALUES(204, 'USER04', 'PASS04', '김영한', 'M', '부산 해운대', '010-4545-5454', 'N', DEFAULT);

INSERT INTO TB_MEMBER 
VALUES(205, 'USER05', 'PASS05', '박은빈', 'F', '서울 신촌', '010-5555-5555', 'N', '2017/03/02');
...
INSERT INTO TB_RENT
VALUES(301, 202, 101, DEFAULT);

INSERT INTO TB_RENT
VALUES(302, 203, 102, '2020/02/21');

INSERT INTO TB_RENT
VALUES(303, 204, 103, '2022/02/22');
