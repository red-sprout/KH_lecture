...
public class SetRun {
	public static void main(String[] args) {
		...
		// Object에 hashCode() => 해당 객체의 "주소값"을 가지고 10진수 형태로 만들어서 반환
		...
		// String의 equals() 오버라이딩 => "실제 담긴 문자열"을 가지고 동등비교를 진행하여 일치하면 true/ 일치하지 않으면 false 반환
		// String의 hashCode() 오버라이딩 => "실제 담긴 문자열"을 가지고 10진수 형태로 만들어서 반환
		...
		// Student에 hashCode() 오버라이딩 => "실제 각 필드에 담긴 데이터"들의 hashCode를 다 더해준 값을 반환
		...
		// ArrayList담는 방법1. : ArrayList 생성 후 addAll메소드를 이용해서 통채로 추가
