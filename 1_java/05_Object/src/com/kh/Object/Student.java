 ...
 * protected : 같은 패키지에서 또는 다른 패키지일경우 상속구조(부모자식 관계)에서만 접근
...
public class Student { // 학생을 추상화해서 만든 클래스다.
	 ...
	 */
	private String name;
	private int age; // 나이는 1년에 1살 증가, 나이는 무조건 0보다 크다
	...
	// getter, setter
	// getter : 해당필드에 값을 가지고오기 위한 메소드
	// setter : 해당필드에 값을 대입시키기 위한 메소드
