...
public class C_Wrapper {
	/*
	 * Wrapper 클래스
	 * => 기본 자료형을 객체로 포장해줄 수 있는 클래스가 레퍼 클래스이다.
	 * => 기본 자료형을 객체로 표현해야 할 경우
	 * 	- 메소드 호출해야될 때
...
//		System.out.println(num1.equals(num2)); // 컴파일에러
		...
		// 2. 객체 생성 따위 하지 않고 곧바로 대입(AutoBoxing)
		Integer i3 = num1;
		System.out.println(i3);
		
		// 객체생성을 통해서 반드시 변환해야하는 경우 -> 문자열을 Integer 타입으로 변환하고 싶을 때
