...
public class B_String {
	public void method01() {
		...
		// String 클래스의 toString 메소드 : 이미 오버라이딩 되어있음!(실제 담긴 문자열을 반환하도록)
		...
		// String 클래스에 hashCode 메소드는 이미 오버라이딩 되어있다. (주소값이 아닌 문자열을 가지고 진행)
		
		// 주소값에 대한 해시토드가 알고 싶다면 identityHashCode 메소드를 이용해야 한다.
		...
		// 새로운 곳을 참조하도록 됨 (새로운 주소값 부여받은 == 주소값 변경)
	...
	public void method02() {
		...
		String str2 = str1.concat("!!!"); // 새로운 객체 생성 후 return
		System.out.println("str2 : " + str2);
		
		String str3 = str1 + "!!!"; // 그냥 literal
		...
		//		=> 문자열의 beginIndex 위치에서부터 endIndex-1 까지 문자열을 추출
...
//		System.out.println(st.nextToken());
//		
//		System.out.println(st.nextToken()); // NoSuchElementException (더이상 요소가 없습니다.)
