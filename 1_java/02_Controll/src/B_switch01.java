...
public class B_switch01 {
	 ...
	 * case 값2 : 실행코드2; break;
	 * ...
	 * default : 위의 값등이 모두 일치하지 않았을 때 실행하는 코드;
	 * }
	 */
...
//		fruitMap.put("바나나", 2000);
//		fruitMap.put("딸기", 3000);
//		
//		if(fruitMap.get(fruit) != null) {
//			System.out.println(fruit + "의 가격은 " + fruitMap.get(fruit) + "입니다.");
//		} else {
//			System.out.println("잘못입력하였습니다.");
//		}
...
//		switch(fruit) {
//		case "사과": 
//			System.out.println(fruit + "의 가격은 1000입니다.");
//			break;
//		case "바나나":
