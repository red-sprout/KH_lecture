...
//		
		...
		/*
		 * 연결이 끊어진 기존 배열은 Heap 영역에 둥둥 떠다님
		 * (어디에도 참조되어 있지않아 사용되지 않음 => 필요없는 존재)
		 * => 일정시간이 지나면 "가비지컬렉터(GC)"가 알아서 지워줌
		 * => 자바에서의 "자동메모리 관리" 특징 == 개발자가 코드작정에만 집중할 수 있다.
		 */
