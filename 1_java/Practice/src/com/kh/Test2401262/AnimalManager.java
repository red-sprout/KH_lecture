...
public class AnimalManager {
	...
	public static void main(String[] args) {
		...
		animals[0] = new Dog("흰둥이", "비숑", 5);
		animals[1] = new Cat("폴", "페르시안", "서울", "흰색");
		animals[2] = new Dog("바둑이", "시고르자브종", 4);
		animals[3] = new Cat("짬타이거", "길냥이", "동탄", "검은색");
		animals[4] = new Dog("루시", "리트리버", 10);
